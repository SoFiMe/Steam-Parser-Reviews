...
class SteamReviewsDownloader:
            ...
            while len(reviews) < max_reviews:
                ...
                for r in batch_reviews:
                    ...
                    if rid not in seen_ids:
                        ...
                        games_display = "Скрытый профиль" if is_private else games_owned
                        ...
                        reviews.append({
                            ...
                            'Helpful': helpful,
                            'Funny': funny,
                            'Кол-во игр': games_display,
                            'Кол-во игр_число': games_owned,
    ...
    def calculate_hours_stats(self, df):
        ...
        return self._calculate_group_stats(df_copy, 'Группа часов', 'Группа часов')
    ...
    def calculate_reviews_count_stats(self, df):
        ...
        df_copy = df.copy()
        df_copy['Кол-во отзывов автора'] = df_copy['Кол-во отзывов'].apply(get_reviews_group)
        return self._calculate_group_stats(df_copy, 'Кол-во отзывов автора', 'Кол-во отзывов автора')
    ...
    def calculate_games_count_stats(self, df):
        def get_games_group(row):
            ...
            if 'Кол-во игр_число' in row.index:
                count = row['Кол-во игр_число']
            else:
        ...
        df_copy = df.copy()
        df_copy['Кол-во игр автора'] = df_copy.apply(get_games_group, axis=1)
        return self._calculate_group_stats(df_copy, 'Кол-во игр автора', 'Кол-во игр автора')
    ...
    def save_to_excel(self, reviews, appid, game_name=None):
        ...
        if 'Кол-во игр_число' in df.columns:
            df.drop(columns=['Кол-во игр_число'], inplace=True)
